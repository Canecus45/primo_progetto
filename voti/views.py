...
def media_voti(request):
    ...
    for studente,voti_studente in voti:
        studenti.append(studente)
        for materia,voti,assenze in voti_studente:
            somma_voti+=voti
        numero_voti=len(voti_studente)
        media_studente=somma_voti/numero_voti
        medie[studente]=media_studente
        contex={
            "medie":medie,
            "studenti":studenti,
        }

    return render(request, "media_voti.html", contex)
